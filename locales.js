...
const LOCALES = {
    en: {
        ...
        connectDescription:
            'Enter your API key to start saving prompts from any website.',
        apiKey: 'API Key',
        ...
        quickSaveDescription:
            'Select text on any webpage and right-click to quickly save it as a prompt.',
        ...
        clearDataHint:
            'This only removes local data and disconnects the extension. Your PromptPocket account is not affected.',
    ...
    fr: {
        ...
        connectDescription:
            "Entrez votre clé API pour commencer à enregistrer des prompts depuis n'importe quel site.",
        apiKey: 'Clé API',
        apiKeyPlaceholder: 'ppk_XXXX-XXXX-XXXX-XXXX-XXXX-XXXX-XXXX-XXXX',
        connect: 'Connexion',
        ...
        quickSaveDescription:
            "Sélectionnez du texte sur n'importe quelle page et faites un clic droit pour l'enregistrer rapidement comme prompt.",
        ...
        clearDataHint:
            "Cela supprime uniquement les données locales et déconnecte l'extension. Votre compte PromptPocket n'est pas affecté.",
    ...
    de: {
        ...
        connectDescription:
            'Geben Sie Ihren API-Schlüssel ein, um Prompts von jeder Website zu speichern.',
        ...
        quickSaveDescription:
            'Wählen Sie Text auf einer beliebigen Webseite aus und klicken Sie mit der rechten Maustaste, um ihn schnell als Prompt zu speichern.',
        ...
        clearDataHint:
            'Dies entfernt nur lokale Daten und trennt die Erweiterung. Ihr PromptPocket-Konto ist nicht betroffen.',
